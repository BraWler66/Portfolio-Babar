...
import AutonomousCar from "./Projects/AutonomousCar"
import HumandBody from "./Projects/HumandBody"
  ...
  return (
    <section id="projects" className="py-20 md:py-32 bg-accent/10">
      <div className="container max-w-7xl">
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-start gap-4">
          <div>
            <h2 className="text-3xl font-bold mb-4">
              <span className="font-mono text-primary">#</span> Featured Projects
            </h2>
            <p className="text-muted-foreground max-w-2xl">
              A selection of my recent projects, focused on AI, machine learning, and innovative technologies. Each project represents a step in my journey as a creator of intelligent systems.
            </p>
          </div>
          <Link href="/projects">
        ...
        <div className="bodyhuman">
          <HumandBody />
        </div>

        <hr />

        <div className="car my-20">
          <AutonomousCar />
        </div>
